...
class ListOrderMacaronAdapter(private val orderList: List<Macaron>) : RecyclerView.Adapter<ListOrderMacaronAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListOrderMacaronAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ListOrderMacaronAdapter.ViewHolder, position: Int) {
        val listOrder: Macaron = orderList[position]
