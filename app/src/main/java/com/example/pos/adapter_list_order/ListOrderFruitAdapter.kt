...
class ListOrderFruitAdapter(private val orderList: List<Fruit>) : RecyclerView.Adapter<ListOrderFruitAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListOrderFruitAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ListOrderFruitAdapter.ViewHolder, position: Int) {
        val listOrder: Fruit = orderList[position]
