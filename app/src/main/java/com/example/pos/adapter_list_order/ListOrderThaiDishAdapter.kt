...
class ListOrderThaiDishAdapter(private val orderList: List<ThaiDish>) : RecyclerView.Adapter<ListOrderThaiDishAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListOrderThaiDishAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ListOrderThaiDishAdapter.ViewHolder, position: Int) {
        val listOrder: ThaiDish = orderList[position]
