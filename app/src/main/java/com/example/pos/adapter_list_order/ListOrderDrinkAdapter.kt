...
class ListOrderDrinkAdapter(private val orderList: List<Drink>) : RecyclerView.Adapter<ListOrderDrinkAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListOrderDrinkAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ListOrderDrinkAdapter.ViewHolder, position: Int) {
        val listOrder: Drink = orderList[position]
