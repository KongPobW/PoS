...
class FruitAdapter(private val fList: List<Fruit>, private val onItemClicked: (Fruit) -> Unit) : RecyclerView.Adapter<FruitAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val context = parent.context
        val inflater = LayoutInflater.from(context)
        val fruitView = inflater.inflate(R.layout.item_list_product, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (position) {
            0 -> imageView.setImageResource(R.drawable.watermelon)
            1 -> imageView.setImageResource(R.drawable.apple)
            2 -> imageView.setImageResource(R.drawable.pineapple)
            3 -> imageView.setImageResource(R.drawable.banana)
        ...
        priceText.setText(fruit.dPrice.toString())
    }
